        ...
        <DialogPanel class="w-full max-w-4xl shadow border-b border-gray-200">
            <div class="bg-white px-1 pt-5 pb-8 col-lg-12 rounded-md shadow border-b border-gray-200">
                <div class="mt-3 text-center sm:mt-0 sm:ml-2 sm:text-left">
                    <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900 break-all">Voting Simulator</DialogTitle>
                <div>
                ...
                <div class="mt-4 mr-4 ml-2 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="w-full text-xs divide-y divide-gray-200 table-fixed">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <button @click.prevent="addMemberRow" type="button" class="px-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-aftrBlue bg-white hover:bg-aftrBlue hover:text-white focus:outline-none">
                            ...
                            <tr v-show="addRow" class="text-xs text-gray-500 hover:bg-gray-50">
                                ...
                                <td class="text-right px-4 py-2">
                                    <input type="number" v-model="newQty" @blur="onDirty" class="mt-1 mb-1 mr-4 text-xs text-right focus:ring-aftrBlue focus:border-aftrBlue shadow-sm border-gray-300 rounded-md"/>
                                </td>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="(value, index) in memberData" :key="value.member" class="hover:bg-gray-50">
                                ...
                                <td class="text-center px-1 py-3 text-gray-500">
                                    <input type="number" v-model="value.token" @change="tokenValue(value, index)" class="mt-1 mb-1 mr-4 text-xs text-right focus:ring-aftrBlue focus:border-aftrBlue shadow-sm border-gray-300 rounded-md"/>
                                </td>
                    ...
                    <div class="mt-4 p-4">
                        ...
                        <dl class="mt-5 grid grid-cols-5 gap-5">
                            ...
                            <div class="col-span-2 text-sm text-gray-700 text-center">Voting can end as soon as either of these are met</div>
