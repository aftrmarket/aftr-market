<template>
  <Dialog :open="isOpen" @close="setIsOpen" class="relative z-50">
    <div
      ...
      "
    >
      <DialogPanel class="w-full max-w-2xl shadow border-b border-gray-200">
        <perfect-scrollbar>
          <div
            class="
              bg-white
            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-2 sm:text-left">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      >
                        ...
                        <td class="text-center px-1 py-6 text-gray-500">
                          ...
                          >
                          <button
                            class="w-full mt-2 rounded-md shadow bg-indigo-200"
                            @click="resetInput(value, index)"
                          >
                            Reset
                          </button>
                        </td>
                ...
                <div class="mt-4">
                  ...
                  <div class="info">
                    Red color for negative result and Green color for positive
                    color.
                  </div>
