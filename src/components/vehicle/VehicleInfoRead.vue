        ...
        <div class="flex items-center justify-between">
            ...
            <div class="px-4 py-6 sm:px-6 grid grid-cols-2 gap-x-4">
                ...
                <label :class="vehicleRunningSrcClass">
                    ...
                    <span v-if="vehicleRunningSourceId === getEvolvedContractSrcId" class="py-1">
                ...
                <label class="block text-aftrBlue text-lg font-mono tracking-wider">{{ walletAddressSubstr(getEvolvedContractSrcId) }}</label>
            </div>
        </div>
    ...
    computed: {
        ...
        vehicleRunningSourceId() {
            if (this.vehicle.evolve !== "") {
                ...
                return this.getEvolvedContractSrcId;
            }
        },
        vehicleRunningSrcClass() {
            if (this.vehicleRunningSourceId !== this.getEvolvedContractSrcId) {
        ...
        ...mapGetters(['getActiveAddress', 'getEvolvedContractSrcId']),
    },
    methods: {
        voteSimulatorTest(){
