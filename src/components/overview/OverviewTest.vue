        ...
        <div class="py-6 bg-gray-50 overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
                <div class="text-base max-w-prose mx-auto lg:max-w-none">
                    <h2 class="text-base text-aftrBlue font-semibold tracking-wide uppercase">About</h2>
        ...
        <div class="py-4 bg-gray-50 overflow-hidden lg:py-4">
            <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
                <div class="text-base max-w-prose mx-auto lg:max-w-none">
                    ...
                    <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">What Happens When I Press the Launch Button?</p>
                </div>
...
const initProcess = [
    ...
    },
    {
        ...
        description:
            "Ensure AFTR Vehicles are ready for your session.",
        icon: TruckIcon,
    },
    {
        id: 4,
