                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div class="">
                                            <div class="mt-6">
                                                <input type="text" v-model="memberWallet" placeholder="Wallet Address"
                                                    @input="onTokenChange" :class="inputBox(memberWalletValid)"
                                                    class="w-96" />
                                            </div>
                                            <div class="mt-6 pl-4">
                                                <input type="number" placeholder="Tokens" v-model="memberAmount"
                                            ...
                                            <div class="mt-6 pl-4">
                                                <button v-if="memberWalletValid && memberAmountValid"
                                                    @click.prevent="addDaoMember" type="button"
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">
                                            Are you sure you want to add this member to the repo?
                                        </p>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        transferTokens() {
            this.$log.info("RepoMembers : transferTokens :: ", "TRANSFER");
            this.$emit('close');
        },
        pstChange() {
