              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="pt-6 text-sm font-medium">
                  ...
                  <dl>
                    ...
                    <perfect-scrollbar>
                      <div class="mt-4 mb-4 grid grid-cols-3 gap-x-4" v-for="(tokens, addr) in voteData.votingPower"
                        :key="addr">
                    ...
                    <div class="mt-4 mb-4 grid grid-cols-3 gap-x-4 border-t border-gray-300">
                      ...
                      <div v-if="repo.ownership == 'single'" class="text-gray-500">1</div>
                      <div v-if="repo.ownership == 'multi'" class="text-gray-500">{{ total }}</div>
                    </div>
                  </dl>

                  <div v-if="repo.ownership == 'multi'">
                  ...
                  <dl v-if="voteData.status == 'quorumFailed'">
                    <dt class="text-gray-500">The proposal failed due to the Quorum not being met. The proposal's quorum
                      was {{ repo.settings[0][1] }}</dt>
                  </dl>

                  <div class="flex flex-row justify-center mt-5">
                    <svg v-if="voteData.statusNote && voteData.status == 'passed'" xmlns="http://www.w3.org/2000/svg"
                      class="h-10 w-10" viewBox="0 0 20 20" fill="green">
                      <path fill-rule="evenodd"
                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                        clip-rule="evenodd" />
                    </svg>
                    <svg v-if="voteData.statusNote && voteData.status != 'passed'" xmlns="http://www.w3.org/2000/svg"
                      class="h-10 w-10" viewBox="0 0 20 20" fill="red">
                      <path fill-rule="evenodd"
